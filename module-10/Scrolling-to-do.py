...
class Todo(tk.Tk):
    def __init__(self, tasks=None):
        ...
        # Changing the title with my last name-ToDo
        self.title("Shrestha-ToDo")
        ...
        # Menu colors (2 complementary colors)
        menu_bg = "navy"
        menu_fg = "orange"
        active_bg = "orange"
        active_fg = "navy"

        menubar = tk.Menu(self, bg=menu_bg, fg=menu_fg, activebackground=active_bg, activeforeground=active_fg)

        file_menu = tk.Menu(menubar, tearoff=0, bg=menu_bg, fg=menu_fg,
                            activebackground=active_bg, activeforeground=active_fg)

        # File -> Exit menu item ends the program correctly
        ...
        # Change delete from LEFT click to RIGHT click
        ...
        self.colour_schemes = [{"bg": "gold", "fg": "black"},
                               {"bg": "purple", "fg": "white"}]
